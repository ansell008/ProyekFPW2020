...
<div class="appertment_area">
    <div class="appertment_active owl-carousel">
        <div class="single_appertment">
            <div class="thumb">
                <img src="hus/img/appertment/1.png" alt="">
            </div>
        ...
        <div class="single_appertment">
            <div class="thumb">
                <img src="hus/img/appertment/2.png" alt="">
            </div>
            <div class="appertment_info">
                <span>$35.000</span>
                <a href="#">
        ...
        <div class="single_appertment">
            <div class="thumb">
                <img src="hus/img/appertment/3.png" alt="">
            </div>
            <div class="appertment_info">
                <span>$35.000</span>
                <a href="#">
                            ...
                            <div class="col-lg-9">
                                <div class="single_testmonial text-center">
                                    <div class="author_thumb">
                                        <img src="hus/img/testmonial/author.png" alt="">
                                    </div>
                    ...
                    <div class="single_carousel">
                        <div class="row justify-content-center">
                            <div class="col-lg-9">
                                <div class="single_testmonial text-center">
                                    <div class="author_thumb">
                                        <img src="hus/img/testmonial/author2.png" alt="">
                                    </div>
                                    <div class="testmonial_author">
                                        <h3>Margaret Lawson</h3>
                                        <span>Creative Director</span>
